...
const OurServicesSection = () => {
  return (
    <div className="text-white bg-green-700/40 flex flex-col gap-8 items-center text-center p-20 justify-center">
        ...
        <h2 className="md:text-4xl text-2xl font-serif">Welcome to our bookstore, where stories come alive! We offer a curated selection of books across genres, along with personalized recommendations to ignite your love for reading.</h2>
